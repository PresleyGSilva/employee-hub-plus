  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <h1 className="text-3xl font-bold">Registros de Ponto</h1>
          ...
          <div className="overflow-x-auto">
            <Table>
              ...
              <TableBody>
                ...
                {rows.length === 0 && <TableRow><TableCell colSpan={7} className="text-center py-8 text-muted-foreground">Nenhum registro nesta data</TableCell></TableRow>}
              </TableBody>
            </Table>
          </div>
        </CardContent>
